...
type DecoratorBase<chain extends Chain | undefined = Chain | undefined, account extends Account | undefined = Account | undefined> = {
    accessKey: {
        /**
         ...
         * @returns The transaction hash.
         */
        burnWitness: (parameters: accessKeyActions.burnWitness.Parameters<chain, account>) => Promise<accessKeyActions.burnWitness.ReturnValue>;
        /**
         ...
         * @returns The transaction receipt and event data.
         */
        burnWitnessSync: (parameters: accessKeyActions.burnWitnessSync.Parameters<chain, account>) => Promise<accessKeyActions.burnWitnessSync.ReturnValue>;
        /**
         ...
         */
        isAdmin: (parameters: accessKeyActions.isAdmin.Parameters<account>) => Promise<accessKeyActions.isAdmin.ReturnValue>;
        /**
         ...
         */
        isWitnessBurned: (parameters: accessKeyActions.isWitnessBurned.Parameters<account>) => Promise<accessKeyActions.isWitnessBurned.ReturnValue>;
        /**
         ...
         */
        watchAdminAuthorized: (parameters: accessKeyActions.watchAdminAuthorized.Parameters) => ReturnType<typeof accessKeyActions.watchAdminAuthorized>;
        /**
         ...
         * @returns A function to unsubscribe from the event.
         */
        watchWitness: (parameters: accessKeyActions.watchWitness.Parameters) => ReturnType<typeof accessKeyActions.watchWitness>;
        /**
         ...
         * @returns A function to unsubscribe from the event.
         */
        watchWitnessBurned: (parameters: accessKeyActions.watchWitnessBurned.Parameters) => ReturnType<typeof accessKeyActions.watchWitnessBurned>;
    };
    amm: {
        /**
    ...
    channel: {
         ...
         * @returns The transaction hash.
         */
        close: (parameters: channelActions.close.Parameters<chain, account>) => Promise<channelActions.close.ReturnValue>;
        /**
         ...
         * @returns The transaction receipt and event data.
         */
        closeSync: (parameters: channelActions.closeSync.Parameters<chain, account>) => Promise<channelActions.closeSync.ReturnValue>;
        /**
         ...
         */
        getStates: <const channel extends channelActions.getStates.Channel | readonly channelActions.getStates.Channel[]>(parameters: channelActions.getStates.Parameters<channel>) => Promise<channelActions.getStates.ReturnValue<channel>>;
        /**
         ...
         * @returns The transaction hash.
         */
        open: (parameters: channelActions.open.Parameters<chain, account>) => Promise<channelActions.open.ReturnValue>;
        /**
         ...
         * @returns The transaction receipt and event data.
         */
        openSync: (parameters: channelActions.openSync.Parameters<chain, account>) => Promise<channelActions.openSync.ReturnValue>;
        /**
         ...
         * @returns The transaction hash.
         */
        requestClose: (parameters: channelActions.requestClose.Parameters<chain, account>) => Promise<channelActions.requestClose.ReturnValue>;
        /**
         ...
         * @returns The transaction receipt and event data.
         */
        requestCloseSync: (parameters: channelActions.requestCloseSync.Parameters<chain, account>) => Promise<channelActions.requestCloseSync.ReturnValue>;
        /**
         ...
         * @returns The transaction hash.
         */
        settle: (parameters: channelActions.settle.Parameters<chain, account>) => Promise<channelActions.settle.ReturnValue>;
        /**
         ...
         * @returns The transaction receipt and event data.
         */
        settleSync: (parameters: channelActions.settleSync.Parameters<chain, account>) => Promise<channelActions.settleSync.ReturnValue>;
        /**
         ...
         */
        signVoucher: (parameters: channelActions.signVoucher.Parameters<account>) => Promise<channelActions.signVoucher.ReturnValue>;
        /**
         ...
         * @returns The transaction hash.
         */
        topUp: (parameters: channelActions.topUp.Parameters<chain, account>) => Promise<channelActions.topUp.ReturnValue>;
        /**
         ...
         * @returns The transaction receipt and event data.
         */
        topUpSync: (parameters: channelActions.topUpSync.Parameters<chain, account>) => Promise<channelActions.topUpSync.ReturnValue>;
        /**
         ...
         * @returns The transaction hash.
         */
        withdraw: (parameters: channelActions.withdraw.Parameters<chain, account>) => Promise<channelActions.withdraw.ReturnValue>;
        /**
         ...
         * @returns The transaction receipt and event data.
         */
        withdrawSync: (parameters: channelActions.withdrawSync.Parameters<chain, account>) => Promise<channelActions.withdrawSync.ReturnValue>;
    };
    dex: {
        /**
         ...
         * @returns The transaction hash.
         */
        cancelStale: (parameters: dexActions.cancelStale.Parameters<chain, account>) => Promise<dexActions.cancelStale.ReturnValue>;
        /**
         ...
         * @returns The transaction receipt and event data.
         */
        cancelStaleSync: (parameters: dexActions.cancelStaleSync.Parameters<chain, account>) => Promise<dexActions.cancelStaleSync.ReturnValue>;
        /**
    ...
    earn: {
        ...
        createErc4626Engine: (parameters: earnActions.createErc4626Engine.Parameters<chain, account>) => Promise<earnActions.createErc4626Engine.ReturnValue>;
        /** Deploys a deterministic ERC-4626 engine and waits for confirmation. */
        createErc4626EngineSync: (parameters: earnActions.createErc4626EngineSync.Parameters<chain, account>) => Promise<earnActions.createErc4626EngineSync.ReturnValue>;
        /** Deploys the EarnShare, EarnVault, and EarnFees contracts. */
        createStack: (parameters: earnActions.createStack.Parameters<chain, account>) => Promise<earnActions.createStack.ReturnValue>;
        /** Deploys an Earn stack and waits for confirmation. */
        createStackSync: (parameters: earnActions.createStackSync.Parameters<chain, account>) => Promise<earnActions.createStackSync.ReturnValue>;
        /** Binds an ERC-4626 engine to its EarnVault. */
        bindErc4626Engine: (parameters: earnActions.bindErc4626Engine.Parameters<chain, account>) => Promise<earnActions.bindErc4626Engine.ReturnValue>;
        /** Binds an ERC-4626 engine and waits for confirmation. */
        bindErc4626EngineSync: (parameters: earnActions.bindErc4626EngineSync.Parameters<chain, account>) => Promise<earnActions.bindErc4626EngineSync.ReturnValue>;
        /** Deploys and binds a complete, resumable ERC-4626 Earn stack. */
        deployErc4626StackSync: (parameters: earnActions.deployErc4626StackSync.Parameters<chain, account>) => Promise<earnActions.deployErc4626StackSync.ReturnValue>;
        /**
    ...
    nonce: {
         ...
         */
        getNonce: (parameters: nonceActions.getNonce.Parameters) => Promise<nonceActions.getNonce.ReturnValue>;
        /**
         ...
         * @returns A function to unsubscribe from the event.
         */
        watchNonceIncremented: (parameters: nonceActions.watchNonceIncremented.Parameters) => () => void;
    };
    fee: {
        /**
         ...
         */
        validateToken: (parameters: feeActions.validateToken.Parameters) => Promise<feeActions.validateToken.ReturnValue>;
        /**
    ...
    receivePolicy: {
         ...
         * @returns The transaction hash.
         */
        burn: (parameters: receivePolicyActions.burn.Parameters<chain, account>) => Promise<receivePolicyActions.burn.ReturnValue>;
        /**
         ...
         * @returns The transaction receipt and event data.
         */
        burnSync: (parameters: receivePolicyActions.burnSync.Parameters<chain, account>) => Promise<receivePolicyActions.burnSync.ReturnValue>;
        /**
         ...
         * @returns The transaction hash.
         */
        claim: (parameters: receivePolicyActions.claim.Parameters<chain, account>) => Promise<receivePolicyActions.claim.ReturnValue>;
        /**
         ...
         * @returns The transaction receipt and event data.
         */
        claimSync: (parameters: receivePolicyActions.claimSync.Parameters<chain, account>) => Promise<receivePolicyActions.claimSync.ReturnValue>;
        /**
         ...
         */
        get: (parameters: receivePolicyActions.get.Parameters<account>) => Promise<receivePolicyActions.get.ReturnValue>;
        /**
         ...
         */
        getBlockedBalance: (parameters: receivePolicyActions.getBlockedBalance.Parameters) => Promise<receivePolicyActions.getBlockedBalance.ReturnValue>;
        /**
         ...
         * @returns The transaction hash.
         */
        set: (parameters: receivePolicyActions.set.Parameters<chain, account>) => Promise<receivePolicyActions.set.ReturnValue>;
        /**
         ...
         * @returns The transaction receipt and event data.
         */
        setSync: (parameters: receivePolicyActions.setSync.Parameters<chain, account>) => Promise<receivePolicyActions.setSync.ReturnValue>;
        /**
         ...
         */
        validate: (parameters: receivePolicyActions.validate.Parameters) => Promise<receivePolicyActions.validate.ReturnValue>;
        /**
         ...
         * @returns A function to unsubscribe from the event.
         */
        watchBlocked: (parameters: receivePolicyActions.watchBlocked.Parameters) => () => void;
        /**
         ...
         * @returns A function to unsubscribe from the event.
         */
        watchBurned: (parameters: receivePolicyActions.watchBurned.Parameters) => () => void;
        /**
         ...
         * @returns A function to unsubscribe from the event.
         */
        watchClaimed: (parameters: receivePolicyActions.watchClaimed.Parameters) => () => void;
        /**
         ...
         * @returns A function to unsubscribe from the event.
         */
        watchUpdated: (parameters: receivePolicyActions.watchUpdated.Parameters) => () => void;
    };
    reward: {
        /**
         ...
         * @returns The transaction hash.
         */
        distribute: (parameters: rewardActions.distribute.Parameters<chain, account>) => Promise<rewardActions.distribute.ReturnValue>;
        /**
         ...
         */
        distributeSync: (parameters: rewardActions.distributeSync.Parameters<chain, account>) => Promise<rewardActions.distributeSync.ReturnValue>;
        /**
         ...
         * @returns A function to unsubscribe from the event.
         */
        watchRewardDistributed: (parameters: rewardActions.watchRewardDistributed.Parameters) => () => void;
        /**
    ...
    simulate: {
         ...
         */
        simulateBlocks: <const calls extends readonly unknown[]>(parameters: simulateActions.simulateBlocks.Parameters<calls>) => Promise<simulateActions.simulateBlocks.ReturnType<calls>>;
        /**
         ...
         */
        simulateCalls: <const calls extends readonly unknown[], account extends Account | Address | undefined = undefined>(parameters: simulateActions.simulateCalls.Parameters<calls, account>) => Promise<simulateActions.simulateCalls.ReturnType<calls>>;
    };
    token: {
        /**
         ...
         */
        getTotalSupply: (parameters: tokenActions.getTotalSupply.Parameters) => Promise<tokenActions.getTotalSupply.ReturnValue>;
        /**
    ...
    zone: {
         ...
         * @returns The transaction hash.
         */
        deposit: (parameters: zoneActions.deposit.Parameters<chain, account>) => Promise<zoneActions.deposit.ReturnValue>;
        /**
         ...
         * @returns The transaction receipt.
         */
        depositSync: (parameters: zoneActions.depositSync.Parameters<chain, account>) => Promise<zoneActions.depositSync.ReturnValue>;
        /**
         ...
         * @returns The transaction hash.
         */
        encryptedDeposit: (parameters: zoneActions.encryptedDeposit.Parameters<chain, account>) => Promise<zoneActions.encryptedDeposit.ReturnValue>;
        /**
         ...
         * @returns The transaction receipt.
         */
        encryptedDepositSync: (parameters: zoneActions.encryptedDepositSync.Parameters<chain, account>) => Promise<zoneActions.encryptedDepositSync.ReturnValue>;
        /**
         ...
         */
        getEncryptionKey: (parameters: zoneActions.getEncryptionKey.Parameters) => Promise<zoneActions.getEncryptionKey.ReturnValue>;
        /**
         ...
         */
        getWithdrawalFee: (parameters?: zoneActions.getWithdrawalFee.Parameters) => Promise<zoneActions.getWithdrawalFee.ReturnType>;
        /**
         ...
         * @returns The transaction hash.
         */
        requestWithdrawal: ((parameters: zoneActions.requestWithdrawal.Parameters<chain, account>) => Promise<zoneActions.requestWithdrawal.ReturnValue>) & {
            prepare: (parameters: zoneActions.requestWithdrawal.prepare.Parameters<chain, account, undefined, undefined>) => Promise<zoneActions.requestWithdrawal.prepare.ReturnType<chain, account, undefined, undefined>>;
        };
        /**
         ...
         * @returns The transaction hash.
         */
        requestVerifiableWithdrawal: (parameters: zoneActions.requestVerifiableWithdrawal.Parameters<chain, account>) => Promise<zoneActions.requestVerifiableWithdrawal.ReturnValue>;
        /**
         ...
         * @returns The transaction receipt.
         */
        requestVerifiableWithdrawalSync: (parameters: zoneActions.requestVerifiableWithdrawalSync.Parameters<chain, account>) => Promise<zoneActions.requestVerifiableWithdrawalSync.ReturnValue>;
        /**
         ...
         */
        signAuthorizationToken: (parameters?: zoneActions.signAuthorizationToken.Parameters<account>) => Promise<zoneActions.signAuthorizationToken.ReturnType>;
    };
};
type BoundHelper<helper> = helper extends (...parameters: infer parameters) => infer returnType ? parameters extends [Client<any, any, any>, infer args, ...unknown[]] ? (args: args) => returnType : parameters extends [Client<any, any, any>] ? () => returnType : parameters extends [infer args, ...unknown[]] ? (args: args) => returnType : () => returnType : never;
type BoundActionHelpers<action> = (action extends {
    call: infer helper;
} ? {
...
type DecorateNamespace<namespace, actions> = {
    [key in keyof namespace]: key extends keyof actions ? namespace[key] & BoundActionHelpers<actions[key]> : namespace[key];
} & {
    [key in Exclude<keyof actions, keyof namespace> as actions[key] extends (...parameters: any) => any ? key : never]: BoundAction<actions[key]>;
};
export type Decorator<chain extends Chain | undefined = Chain | undefined, account extends Account | undefined = Account | undefined> = {
    accessKey: DecorateNamespace<DecoratorBase<chain, account>['accessKey'], typeof accessKeyActions>;
    ...
    receivePolicy: DecorateNamespace<DecoratorBase<chain, account>['receivePolicy'], typeof receivePolicyActions>;
    reward: DecorateNamespace<DecoratorBase<chain, account>['reward'], typeof rewardActions>;
    simulate: DecorateNamespace<DecoratorBase<chain, account>['simulate'], typeof simulateActions>;
    token: DecorateNamespace<DecoratorBase<chain, account>['token'], typeof tokenActions>;
    validator: DecorateNamespace<DecoratorBase<chain, account>['validator'], typeof validatorActions>;
    virtualAddress: DecorateNamespace<DecoratorBase<chain, account>['virtualAddress'], typeof virtualAddressActions>;
    zone: DecorateNamespace<DecoratorBase<chain, account>['zone'], typeof zoneActions>;
};
