...
type VerifiedPaymentCancellationReason = "handler_threw" | "handler_failed" | "after_verify_aborted";
...
declare class x402ResourceServer {
     ...
     */
    getPaymentFlow(_payload: DeepReadonly<PaymentPayload>, requirements: DeepReadonly<PaymentRequirements>): PaymentFlowName;
    /**
     ...
     */
    createPaymentCancellationDispatcher(paymentPayload: PaymentPayload, requirements: PaymentRequirements, declaredExtensions?: Record<string, unknown>, transportContext?: unknown, settledPhases?: readonly SettlePhase[]): PaymentCancellationDispatcher;
    /**
     ...
     * @returns Settlement response
     */
    settlePayment(paymentPayload: PaymentPayload, requirements: PaymentRequirements, declaredExtensions?: Record<string, unknown>, transportContext?: unknown, settlementOverrides?: SettlementOverrides, phase?: SettlePhase): Promise<SettleResponse>;
    /**
     ...
     */
    private validateFacilitatorCapabilities;
    /**
...
declare const PAYMENT_REQUIRED_CACHE_CONTROL = "no-store";
/**
...
interface RouteValidationError {
    ...
    reason: "missing_scheme" | "missing_facilitator" | "unsupported_asset_transfer_method" | "unsupported_payment_flow";
...
declare class x402HTTPResourceServer {
     ...
     */
    createCompletedSettlementHeaders(settlement: CompletedSettlement, existingCacheControl?: string | null): Record<string, string>;
    /**
 ...
 * did not occur.
 */
declare class FacilitatorTimeoutError extends FacilitatorResponseError {
...
interface SchemeNetworkServer {
     ...
     */
    validateFacilitatorSupport?(network: Network, supportedKind: SupportedKind, facilitatorExtensions: string[]): string | void;
}
...
export { type SettleResultContext as $, HTTPFacilitatorClient as A, type FacilitatorClient as B, type CompiledRoute as C, type DynamicPayTo as D, type FacilitatorConfig as E, type FacilitatorExtension as F, FacilitatorResponseError as G, type HTTPAdapter as H, FacilitatorTimeoutError as I, getFacilitatorResponseError as J, type PaymentFlowName as K, type PaymentFlowPhases as L, type SchemeNetworkServer as M, type Network as N, type DeepReadonly as O, type PaymentPayload as P, x402ResourceServer as Q, type RouteConfig as R, type SettleResponse as S, type ResourceConfig as T, type UnpaidResponseBody as U, type VerifyResponse as V, type PaymentRequiredContext as W, type VerifyContext as X, type VerifyResultContext as Y, type VerifyFailureContext as Z, type SettleContext as _, type PaymentRequirements as a, type FacilitatorContext as a$, type SettleFailureContext as a0, type SettlePhase as a1, type VerifiedPaymentCanceledContext as a2, type VerifiedPaymentCancellationReason as a3, type VerifiedPaymentCancelOptions as a4, type PaymentCancellationDispatcher as a5, type CompletedSettlement as a6, type SettlementOverrides as a7, type ExtensionValidationResult as a8, type SkipHandlerDirective as a9, type ClientExtension as aA, type PaymentPolicy as aB, type SchemeRegistration as aC, type x402ClientConfig as aD, type PaymentRequirementsV1 as aE, type PaymentRequiredV1 as aF, type PaymentPayloadV1 as aG, type VerifyRequestV1 as aH, type SettleRequestV1 as aI, type SettleResponseV1 as aJ, type SupportedResponseV1 as aK, type Money as aL, type AssetAmount as aM, type Price as aN, type VerifyRequest as aO, type SettleRequest as aP, type SupportedResponse as aQ, type SupportedKind as aR, VerifyError as aS, SettleError as aT, type ResourceInfo as aU, type SchemeNetworkClient as aV, type SchemeClientHooks as aW, type SchemeServerHooks as aX, type MoneyParser as aY, type PaymentPayloadResult as aZ, type PaymentPayloadContext as a_, type ResourceVerifyRespone as aa, type BeforeVerifyHook as ab, type AfterVerifyHook as ac, type OnVerifyFailureHook as ad, type BeforeSettleHook as ae, type AfterSettleHook as af, type OnSettleFailureHook as ag, type OnVerifiedPaymentCanceledHook as ah, type SchemeEnrichPaymentRequiredResponseHook as ai, type SchemePaymentRequiredContext as aj, type SchemeEnrichSettlementPayloadHook as ak, type SchemeEnrichSettlementResponseHook as al, type PaymentFlowConfig as am, checkIfBazaarNeeded as an, x402Client as ao, type PaymentCreationContext as ap, type PaymentCreatedContext as aq, type PaymentCreationFailureContext as ar, type BeforePaymentCreationHook as as, type AfterPaymentCreationHook as at, type OnPaymentCreationFailureHook as au, type PaymentResponseContext as av, type OnPaymentResponseHook as aw, type SelectPaymentRequirements as ax, type ClientExtensionHooks as ay, type ClientTransportExtensionHooks as az, type SchemeNetworkFacilitator as b, type ResourceServerExtension as b0, type ResourceServerExtensionHooks as b1, type PaymentRequired as c, type HTTPRequestContext as d, type HTTPTransportContext as e, type HTTPResponseInstructions as f, type HTTPProcessResult as g, type PaywallConfig as h, type PaywallProvider as i, type PaymentOption as j, type RoutesConfig as k, type DynamicPrice as l, type HTTPResponseBody as m, type SettlementFailedResponseBody as n, type ProcessSettleResultResponse as o, type ProcessSettleSuccessResponse as p, type ProcessSettleFailureResponse as q, type RouteValidationError as r, RouteConfigurationError as s, type ProtectedRequestHook as t, type HTTPResourceServerExtensionHooks as u, type ResourceServerTransportExtensionHooks as v, SETTLEMENT_OVERRIDES_HEADER as w, x402HTTPResourceServer as x, PAYMENT_REQUIRED_CACHE_CONTROL as y, withPrivateCacheControl as z };
