...
async function verifyTypedDataSignature(signer, params) {
  let digest;
  try {
    digest = (0, import_viem7.hashTypedData)({
...
async function verifyECDSA(address, digest, signature) {
  ...
  try {
    const recovered = await (0, import_viem7.recoverAddress)({ hash: digest, signature });
    return (0, import_viem7.isAddressEqual)((0, import_viem7.getAddress)(recovered), (0, import_viem7.getAddress)(address));
  } catch {
    return false;
  }
}
...
async function multicall(readContract, calls) {
  ...
  return rawResults.map((raw, i) => {
    ...
    try {
      const decoded = (0, import_viem8.decodeFunctionResult)({
        abi: call.abi,
        functionName: call.functionName,
        data: raw.returnData
      });
...
async function simulatePermit2SettleWithErc20Approval(config, extensionSigner, settleArgs, erc20Info) {
  ...
  try {
    const settleData = (0, import_viem9.encodeFunctionData)({
      abi: config.proxyABI,
      functionName: "settle",
      args: settleArgs
    });
...
function buildUptoPermit2SettleArgs(permit2Payload, settlementAmount, facilitatorAddress) {
  const { signature } = (0, import_viem9.parseErc6492Signature)(permit2Payload.signature);
  return [
    {
      permitted: {
    ...
    settlementAmount,
    (0, import_viem9.getAddress)(permit2Payload.permit2Authorization.from),
    {
      to: (0, import_viem9.getAddress)(permit2Payload.permit2Authorization.witness.to),
      facilitator: (0, import_viem9.getAddress)(facilitatorAddress),
...
async function verifyUptoPermit2(signer, payload, requirements, permit2Payload, context, options) {
  ...
  if ((0, import_viem10.getAddress)(permit2Payload.permit2Authorization.spender) !== (0, import_viem10.getAddress)(x402UptoPermit2ProxyAddress)) {
    return {
      isValid: false,
  ...
  if ((0, import_viem10.getAddress)(permit2Payload.permit2Authorization.witness.to) !== (0, import_viem10.getAddress)(requirements.payTo)) {
    return {
      isValid: false,
  ...
  const witnessFacilitator = (0, import_viem10.getAddress)(permit2Payload.permit2Authorization.witness.facilitator);
  const isFacilitatorMatch = facilitatorAddresses.some(
    (addr) => (0, import_viem10.getAddress)(addr) === witnessFacilitator
  );
  ...
  if ((0, import_viem10.getAddress)(permit2Payload.permit2Authorization.permitted.token) !== tokenAddress) {
    return {
      isValid: false,
  ...
  const permit2TypedData = {
    ...
    message: {
      ...
      spender: (0, import_viem10.getAddress)(permit2Payload.permit2Authorization.spender),
      nonce: BigInt(permit2Payload.permit2Authorization.nonce),
      deadline: BigInt(permit2Payload.permit2Authorization.deadline),
      witness: {
        to: (0, import_viem10.getAddress)(permit2Payload.permit2Authorization.witness.to),
        facilitator: (0, import_viem10.getAddress)(permit2Payload.permit2Authorization.witness.facilitator),
        validAfter: BigInt(permit2Payload.permit2Authorization.witness.validAfter)
      }
    }
  };
  ...
  const facilitatorAddress = (0, import_viem10.getAddress)(permit2Payload.permit2Authorization.witness.facilitator);
