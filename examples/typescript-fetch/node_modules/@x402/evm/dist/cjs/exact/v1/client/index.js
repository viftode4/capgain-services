...
var ExactEvmSchemeV1 = class {
  ...
  async createPaymentPayload(x402Version, paymentRequirements) {
    ...
    const authorization = {
      ...
      to: (0, import_viem10.getAddress)(selectedV1.payTo),
  ...
  async signAuthorization(authorization, requirements) {
    ...
    const domain = {
      ...
      version,
      chainId,
      verifyingContract: (0, import_viem10.getAddress)(requirements.asset)
    };
    const message = {
      from: (0, import_viem10.getAddress)(authorization.from),
      to: (0, import_viem10.getAddress)(authorization.to),
