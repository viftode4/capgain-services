...
var ExactEvmSchemeV1 = class {
  ...
  async createPaymentPayload(x402Version, paymentRequirements) {
    ...
    const authorization = {
      ...
      to: (0, import_viem14.getAddress)(selectedV1.payTo),
  ...
  async signAuthorization(authorization, requirements) {
    ...
    const domain = {
      ...
      version,
      chainId,
      verifyingContract: (0, import_viem14.getAddress)(requirements.asset)
    };
    const message = {
      from: (0, import_viem14.getAddress)(authorization.from),
      to: (0, import_viem14.getAddress)(authorization.to),
      value: BigInt(authorization.value),
      validAfter: BigInt(authorization.validAfter),
      validBefore: BigInt(authorization.validBefore),
      nonce: authorization.nonce
